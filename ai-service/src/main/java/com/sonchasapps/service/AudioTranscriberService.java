...
//    private static final String OPERATION_URL = "https://operation.api.cloud.yandex.net/operations/";
//
//    @Value("${YANDEX_API:my_token}")
//    private String apiKey;
//
//    public String transcribe(String audioUri) {
//        try {
//            String operationId = startRecognition(audioUri);
...
//    }
//
//    private String startRecognition(String uri) throws IOException {
//        JSONObject body = new JSONObject()
//                .put("config", new JSONObject()
//                        .put("specification", new JSONObject()
//                                .put("languageCode", "ru-RU")
...
//                                .put("literatureText", false)
//                                .put("audioEncoding", "MP3")))
//                .put("audio", new JSONObject().put("uri", uri));
//
//        Request request = new Request.Builder()
//                .url(STT_URL)
//                .addHeader("Authorization", "Api-Key " + apiKey)
...
//    }
//
//    private String waitForOperation(String id) throws Exception {
//        while (true) {
//            Request request = new Request.Builder()
//                    .url(OPERATION_URL + id)
//                    .addHeader("Authorization", "Api-Key " + apiKey)
//                    .build();
//
...
//                JSONArray alternatives = firstChunk.getJSONArray("alternatives");
//                return alternatives.getJSONObject(0).getString("text");
//            }
//
//            Thread.sleep(1500);
//        }
